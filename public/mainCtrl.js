...
$http.post("http://localhost:7000/getclaims").then(function(response){
...
myApp.controller("invoiceDetailsCtrl", function ($scope, $http, $window, $location, $routeParams) {
	...
	$http.get("http://localhost:7000/getInvoieDetailsById", {params:data}).then(function (response) {
   ...
   //   var  res=JSON.parse($window.localStorage.getItem('ress'));
	 ...
	 // alert("hhff"+Iorder);
			...
			"orderId" :Iorder
	 		  ...
	 		  $http.post("http://localhost:7000/getclaims",data).then(function(response){
			//  $http.post("https://"+window.location.hostname+"/getclaims",data).then(function(response){	                
...
myApp.controller('claimDetailsCtrl', function($scope, $http, $window)
{
		...
		$http.post("http://localhost:7000/getclaimsId",data).then(function(response){	                

  // $http.post("https://"+window.location.hostname+"/getclaimsId",data).then(function(response){	                
